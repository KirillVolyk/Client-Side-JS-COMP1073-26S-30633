...
// Adding one or more items to an array at the end/append with push()
...
// Removing an item from an array at the end with pop()
...
// shift to the right (-1 to index)
// unshift to the left (+1 to index) and what youre adding to the end
...
orig6Array.splice(3,3, "Edmonton Oilers");
