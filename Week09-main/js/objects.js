...
let person = {
    ...
    greetings: function() {
        // Hey, this is Kirill Volyk!
        // alert("Hey, this is " + this.name + "!");
        alert(`Hey, this is ${this.name}!`);
    },
    bio: function() {
       // The interests of Kirill Volyk, of age: 19, of gender: Male, are: -interests-
...
// WILL BE ON EXAM RELATED TO API(diff to students)
let key = "hairColor";
let value = "Brown";
person[key] = value;
...
let person2 = {
    name: "Person2",
    hello: function() {
        return `Howdy, this is ${this.name}`;
    }
};
