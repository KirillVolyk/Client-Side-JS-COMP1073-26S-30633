...
async function populate(){
    ...
    const url = "https://kirillvolyk.github.io/Client-Side-JS-COMP1073-26S-30633/Week11-main/i-scream.json";
...
function populateHeader(json){
    ...
    para.textContent = `Heaad Office: ${json.headOffice}, est. ${json.established}, Status: ${json.active ? "Active" : "Inactive"}`
...
function showTopFlavors(json){
    ...
    for (let i = 0; i < topFlavors.length; i++) {
        ...
        // take it further for rating: new p
        let p3 = document.createElement("p");
        let list = document.createElement("ul");
        
        // STEP 10f: Set the textContent property for each of the above elements (except the UL), based on the JSON content
        h2.textContent = "Name: " + topFlavors[i].name;
        p1.textContent = "Calories: " + topFlavors[i].calories;
        p2.textContent = "Type: " + topFlavors[i].type;
        // take it further for rating: new property
