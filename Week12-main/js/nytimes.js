...
// https://api.nytimes.com/svc/search/v2/articlesearch.json?q=election&api-key=ajTxyDrjscEmexIvp1GWTh9CpySQdGKyflfV3koS9z9YzH5n
const key = "ajTxyDrjscEmexIvp1GWTh9CpySQdGKyflfV3koS9z9YzH5n";
let url;
...
function fetchResults(event) {
    ...
    // https://api.nytimes.com/svc/search/v2/articlesearch.json?q=election&api-key=kVsdvkXM6yEiaUwdQA6gZvXRRWyjcbkAaAFP1X5IOpdJ17zf
    url = `${baseURL}?q=${searchTerm.value}&api-key=${key}&begin_datte=${startDate.value.replaceAll("-", "")}&end_date=${endDate.value.replaceAll("-", "")}`;
    console.log(url);
    // let idk = "word-and-let"
    // idk.
