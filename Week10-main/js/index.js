...
function Coffee(size, isDecaf, qtyCream, qtySugar) {
    ...
    this.description = function() {
        ...
        return `This is a ${this.size} ${this.decaf} coffee with ${this.qtyCream} and ${this.qtySugar}.`;
    }

}

/* STEP 2: Instatiate a coffee based on the above constructor function */
let coffee = new Coffee("small", true, 1, 2);
output.textContent = coffee.description();
...
let myCoffee = Object.create(coffee);
myCoffee.size = "large"
myCoffee.isDecaf = true;
myCoffee.qtyCream = 3;
myCoffee.qtySugar = 1;
...
let otherCoffee = new myCoffee.constructor("medium", false, 0, 3);
